...
class SIPBilling {
    ...
    protected function processCC($xactionRequest, $authOnly = false, $totAmount = 0, $desc = 'SilverIP Comm', $details = false, $paymentMethod = null, $address = null) {
        ...
        if($paymentMethodId != null){
            ...
            $pm = PaymentMethod::find($paymentMethodId);
            if ($pm == null) {
                $result['ERRMSG'] = 'PaymentMethod: id='.$paymentMethodId.' not found.';
                return $result;
            }
            if($pm->account_number == ''){
                $result['ERRMSG'] = 'PaymentMethod: id='.$paymentMethodId.' is missing CC Token. We can not process this request without a CC token.';
            }
            ...
            if (isset($request['CardName']) == false) {
                $result['ERRMSG'] = 'Missing card holder name. We can not process this request without a name.';
                return $result;
            }
        ...
        $request['OrderNumber'] = isset($xactionRequest['OrderNumber']) ? substr($xactionRequest['OrderNumber'], 0, 20) : date('My') . ' Charges';
        // User defied feild - descripton of the charge, i.e. Signup
        $request['UDField2'] = isset($xactionRequest['UDField2']) ? $xactionRequest['UDField2'] : '';
    ...
    public function chargePaymentMethod($paymentMethodId, $amount = 0, $desc = 'SilverIP Comm', $orderNumber = false, $details = false) {
        ...
        $result = $this->processCC($xactionRequest, false, $amount, $desc, $details, null, $paymentMethod);
    ...
    public function chargeCreditCard($cardInfo, $amount = 0, $desc = 'SilverIP Comm',  $orderNumber = false, $details = false, $address = null){
        ...
        $result = $this->processCC($cardInfo, false, $amount, $desc, $details, null, $address);
    ...
    public function authCreditCard($cardInfo, $amount = 0, $desc = 'SilverIP Comm', $orderNumber = false, $details = false, $address = null){
        ...
        $result = $this->processCC($cardInfo, true, $amount, $desc, $details, null, $address);
        $result['TransactionLogId'] = $this->storeXaction($result, null, $address, null,  $details);
