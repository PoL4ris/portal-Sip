...
//        $building->year_built = date('Y-M-d H:i:s');   Keep this commented since we don't have this info in the old database
    ...
    protected function findOrCreateProductPropertyValue(ProductPropertyValueOld $legacyProductPropertyValue)
    {
        ...
        return $this->updateProductPropertyValue($legacyProductPropertyValue, $productPropertyValue);
    }
