...
//      $customerControllerInfo = new CustomerController();
//      $customerNetData = $customerControllerInfo->getCustomerNetwork($request)[0];

//        print '<pre>';print_r($customerData);die();
...
//        print '<pre>';print_r($portOperStatus);die();
        if ($portOperStatus) {
