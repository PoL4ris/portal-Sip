...
<p class='p3'><span class='s1'>If you have any questions or concerns regarding this receipt please contact  SilverIP Customer Support.<span class='Apple-converted-space'></span></p>
<p class='p4'></p>
...
<table width="350" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
    <td height="2px" colspan="2" bgcolor="#FFFFFF"><hr></td>
  </tr>
  <tr>
    <td><p class="p1"><strong>Total Charged</strong></p></td>
    <td><p class="p1"><strong>{{ $invoice->amount }}</strong></p></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
