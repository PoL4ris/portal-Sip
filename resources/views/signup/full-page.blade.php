...
<title>The Montrevelle Account Registration</title>
...
<link rel="stylesheet" type="text/css" href="framework/assets/includes/css/quicksand.css" />
<link rel="stylesheet" type="text/css" href="framework/assets/includes/css/sansation.css" />
<link rel="stylesheet" type="text/css" href="framework/assets/includes/signup/themes/sip_light/css/styles.css" />
<script type="text/javascript" src="framework/assets/includes/js/jquery-1.9.1.js"></script>
<script type="text/javascript" src="framework/assets/includes/signup/js/forms.js"></script>
...
<img src="framework/assets/includes/signup/themes/sip_light/img/SilverIP-Logo-165x65.png" class="centerLogoImage"/><br/>
...
<tr>
<td width='30%'>
<img src='config/img/520H.jpg' class="logoImage" alt="" width="280px" height="241px" style="padding:5px;"/>
</td><td>
<h1>The Montrevelle</h1>
<h2>520 N Halsted Street</h2>
<br/>
<br/>
<br/>
<h3>24/7 Hotline: &nbsp;&nbsp;&nbsp;&nbsp;312-600-3882</h3>
...
<center><div class="divRow">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button id="proceed" value=" Proceed"></button></div></center>
<br/>
</div>
...
<table>
<tr >
<td><img src="framework/assets/includes/signup/themes/sip_light/img/SilverIP-Logo-165x65.png" class="centerLogoImage" style="padding-bottom: 10px;"/> </td>
</tr>
<tr>
<td><h2>The Montrevelle Account Registration<br/></h2></td>
</tr>
</table>
</center>

<div id="backgroundBox">        <form name="signup" action="" class="formGen" method="post">
...
<input type="text" name="field4" id="streetaddress" class="textField required" value="520 N Halsted Street" readonly="readonly"  />
...
<input type="text" name="field5" id="unit" class="textField required" value="401" />
...
<label for="zip">
Zip:                                    </label>
<input type="text" name="field8" id="zip" class="textField required zip" value="60642" readonly="readonly"  />
...
<td colspan="4">
<center>
<div class="redAlert"><img src="framework/assets/includes/signup/themes/sip_light/img/red-sun.png" style="width: 30px; height: 30px; vertical-align: middle;"/> Prepay annually and get one month free. No bills. Set it and forget it!</div>
</center>
</td>
</tr>
<tr>
...
<td><center>
<input type="hidden" name="100-monthly" id="100-monthly"

value="20.00" readonly="readonly" />


<input type="hidden" name="100-annual" id="100-annual"
value="220.00" readonly="readonly" />
...
<td><center>
<input type="hidden" name="500-monthly" id="500-monthly"

value="45.00" readonly="readonly" />


<input type="hidden" name="500-annual" id="500-annual"
value="495.00" readonly="readonly" />
...
<tr>
<td>
<img src="framework/assets/includes/signup/themes/sip_light/img/EA6300_Top.jpg" width="180" height="101"><br/>
</td>
<td rowspan="2">
<center><img src="framework/assets/includes/signup/themes/sip_light/img/cisco-logo.jpg" width="50" height="50"><br/>
EA6300</center><br/>
...
<tr>
<td>
<img src="framework/assets/includes/signup/themes/sip_light/img/EA6300_Back.jpg" width="180" height="43"><br/>
</td>
</tr>
</table>
<table>
...
<div>
Checkout Summary                             <div class="formRow" id="fr_totalcharges" style="display: none">
...
<table width='100%'>
<!--                                                      <tr><td><div class="lineItemHeader" id="serviceChargeIH">Internet Service:</div></td>
<td><div class="lineItemAmount" id="serviceChargeIA">$0.00</div></td></tr>-->
<tr><td><div class="lineItemHeader" id="serviceChargeUpgradeIH">Internet Service:</div></td>
<td><div class="lineItemAmount" id="serviceChargeUpgradeIA">$0.00</div></td></tr>
<tr><td><div class="lineItemHeader" id="WirelessRouterIH">Wireless Router:</div></td>
<td><div class="lineItemAmount" id="WirelessRouterIA">$0.00</div></td></tr>
<tr><td><div class="lineItemHeader" id="VoipPlanIH">Digital Phone Service:</div></td>
<td><div class="lineItemAmount" id="VoipPlanIA">$0.00</div></td></tr>
<tr><td><div class="lineItemHeader" id="VoipFeaturesIH">Digital Phone Features:</div></td>
<td><div class="lineItemAmount" id="VoipFeaturesIA">$0.00</div></td></tr>
<!--                                                      <tr><td><div class="lineItemPromoHeader" id="VoipCreditIH">Digital Phone Credit (1st month):</div></td>
<td><div class="lineItemPromoAmount" id="VoipCreditIA">- $10.00</div></td></tr>-->
<tr><td><div class="lineItemHeader" id="VoipConverterBoxIH">VoIP Converter Box (one-time purchase):</div></td>
<td><div class="lineItemAmount" id="VoipConverterBoxIA">$49.00</div></td></tr>
<tr><td><div class="lineItemPromoHeader" id="VoipSubsidyIH">Instant Rebate on Converter Box:</div></td>
<td><div class="lineItemPromoAmount" id="VoipSubsidyIA">- $20.00</div></td></tr>
<tr><td><div class="lineItemHeader" id="TaxIH">Taxes:</div></td>
<td><div class="lineItemAmount" id="TaxIA">$0.00</div></td></tr>
<tr><td><div class="lineItemHeader" id="SurchargeIH">Surcharge:</div></td>
<td><div class="lineItemAmount" id="SurchargeIA">$0.00</div></td></tr>

<tr><td><div class="lineItemHeader" id="InstallationIH">Installation Fee:</div></td>
<td><div class="lineItemAmount feeAmount" id="InstallationIA" value="0.00">$0.00</div></td></tr>

<tr><td colspan="2"><hr></td></tr>
<!--<tr><td><div class="lineItemTotalHeader" style="width: 179px; text-align: right;">Total Charge:</div></td>-->
<tr><td><div class="lineItemTotalHeader" id="TotChargesIH">Amount Due Now:</div></td>
<td><div class="lineItemTotalAmount" id="TotChargesIA">$0.00</div></td></tr>
<tr><td><div class="lineItemTotalHeader" id="TotVoipChargesIH" style="font-weight: normal; display: none;">1st Month's Charge (Phone service &amp; adapter):</div></td>
<td><div class="lineItemTotalAmount" id="TotVoipChargesIA" style="font-weight: normal; display: none;">$0.00</div></td></tr>
<tr><td><div class="lineItemTotalHeader" id="MonthlyChargesIH" style="font-weight: normal;">Ongoing Monthly Charge:</div></td>
<td><div class="lineItemTotalAmount" id="MonthlyChargesIA" style="font-weight: normal;">$0.00</div></td></tr>
...
<td>
<img src="framework/assets/includes/signup/themes/sip_light/img/payment_methods.jpg" width="188" height="38"><br/>
</td>
</tr>
</table>
</div>
...
<h2>We are processing your order. Please standby while we activate your connection.</h2>
</div>
<div id="thankYou">
<img src="framework/assets/includes/signup/themes/sip_light/img/SilverIP-Logo-165x65.png" class="centerLogoImage"/>
<center>
<br/>
<h1>Thank you!</h1>
<div class="title"><img src="framework/assets/includes/signup/themes/sip_light/img/ok-48.png" style="width: 24px; height: 24px; vertical-align: middle;"/>&nbsp;&nbsp;
...
<!-- 	<div class="msgRow">
<button id="activate" value="Activate Now >>>"></button>
</div> -->
