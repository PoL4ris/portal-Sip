...
return [
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Contracts/Logging/ActivityLog.php',
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Support/Facades/ActivityLog.php',
